...
Command: npx gltfjsx@6.5.3 optimized-room.glb -t 
*/
...
export function Room(props: JSX.IntrinsicElements["group"]) {
  const matcapTexture = useTexture("/assets-2/images/textures/mat1.png");
  const { nodes, materials } = useGLTF(
    "/models/optimized-room.glb"
  ) as unknown as GLTFResult;

  const screensRef = useRef<THREE.Mesh | SelectiveBloomEffect>(null);
